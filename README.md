...
- Note: the input genome or meta-genome can be any number of sequences in a FASTA file, you just need put your sequences in a FASTA file and run ISEScan on it (see [Usage example](#Usage)).
