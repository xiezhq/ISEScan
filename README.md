...
- If you expect an IS element to be identified in your genome but ISEScan didn't, one possibility is that the information of the transposase of the IS element you expect is not included in the current ISEScan pHMM models yet. One solution is to manually add it to ISEScan pHMM models. You can check my answer to [issue #64](https://github.com/xiezhq/ISEScan/issues/64).
